...
inline auto download_json(const char* url) -> std::string
{
...
inline auto download_json_async(const char* url) -> std::future<std::string>
{
...
inline auto download_media_async_ff(std::string& url, std::filesystem::path& path) -> void
{
